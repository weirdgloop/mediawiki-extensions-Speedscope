...
| `$wgSpeedscopeEnableParserProfiler` | `false`                                     | Whether the parser profiler should be enabled and used for preview flamegraphs. This requires a patch to MediaWiki Core.                                                                                                                      |
